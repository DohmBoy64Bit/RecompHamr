...
`core-re`, `evidence-mode`, `build-fix-loop`, `file-format-reversing`, `function-discovery`, `ghidra-mcp`, `n64-debug-mcp`, `mcp-pine`, `objdiff`, `pcsx2`, `bizhawk`, `sega2asm`, `n64-decomp`, `gen-decomp`, `gc-decomp`, `pcrecomp`, `windows-game-decomp`, `xbox360-decomp`, `xboxrecomp`, `gb-recomp`, `ps2recomp`, `ps3recomp`, `snesrecomp`, `project-handoff`, `vb-decomp`
