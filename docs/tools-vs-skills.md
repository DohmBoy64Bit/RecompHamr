...
`core-re`, `evidence-mode`, `build-fix-loop`, `file-format-reversing`, `function-discovery`, `ghidra-mcp`, `n64-debug-mcp`, `mcp-pine`, `n64-decomp`, `pcrecomp`, `windows-game-decomp`, `xbox360-decomp`, `gb-recomp`, `ps3recomp`, `project-handoff`
