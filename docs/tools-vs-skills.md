...
`core-re`, `evidence-mode`, `build-fix-loop`, `file-format-reversing`, `function-discovery`, `ghidra-mcp`, `n64-debug-mcp`, `n64-decomp`, `pcrecomp`, `windows-game-decomp`, `xbox360-decomp`, `project-handoff`
