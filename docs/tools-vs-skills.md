...
`ghidra.*`, `n64-debug-mcp.*`, `pcrecomp.*`, `mcp-pine.*`, `objdiff.*`, `pcsx2.*`, `bizhawk.*`
...
`core-re`, `evidence-mode`, `build-fix-loop`, `file-format-reversing`, `function-discovery`, `ghidra-mcp`, `n64-debug-mcp`, `mcp-pine`, `objdiff`, `pcsx2`, `bizhawk`, `n64-decomp`, `pcrecomp`, `windows-game-decomp`, `xbox360-decomp`, `xboxrecomp`, `gb-recomp`, `ps2recomp`, `ps3recomp`, `snesrecomp`, `project-handoff`
